...
@Entity
@Table(name = "book_ex02")
@NamedQuery(name = "Book02.findAllBooks", query = "SELECT b FROM Book02 b")
public class Book02 implements Serializable {
	...
	public Book02(String title, Float price, String description, String isbn,
	...
	public String toString() {
		return "Book02 [id=" + id + ", title=" + title + ", price=" + price
